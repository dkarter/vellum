...
- THEN it describes default and menu controls, named argv or shell commands, direct bindings, icons, descriptions, availability conditions, and success behavior
